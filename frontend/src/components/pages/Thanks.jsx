...
export const Thanks = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen w-screen text-center'>
      ...
      <h2 className="p-10 text-xl font-semibold">Congratulations! You have reached the end of the survey. Thank yo for completing it! Your completion code to enter into Prolific to validate your participations and get your compensation is : </h2>
      <br />
